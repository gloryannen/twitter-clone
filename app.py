...
def profile():
    ...
    if form.validate_on_submit():
        if User.authenticate(user.username, form.password.data):
            ...
            user.image_url = form.image_url.data or request.form['image_url']
            user.header_image_url = form.header_image_url.data or request.form['header_image_url']
            user.bio = form.bio.data or request.form['bio']
...
def homepage():
    ...
    if g.user:
        ...
        liked_messages_id = [msg.id for msg in g.user.likes]

        return render_template('home.html', messages=messages, likes=liked_messages_id)
